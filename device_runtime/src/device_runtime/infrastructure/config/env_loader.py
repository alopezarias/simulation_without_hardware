...
def load_runtime_config(env: Mapping[str, str] | None = None) -> RuntimeConfig:
    ...
    config = RuntimeConfig(
        ...
        pisugar_socket_path=values.get("DEVICE_PISUGAR_SOCKET_PATH", "/tmp/pisugar-server.sock").strip() or "/tmp/pisugar-server.sock",
        ...
        button_long_press_ms=_get_int(values, "DEVICE_BUTTON_LONG_PRESS_MS", 400),
