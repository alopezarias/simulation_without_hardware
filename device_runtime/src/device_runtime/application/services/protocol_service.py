...
from device_runtime.domain.events import DomainEffect, EffectPayload
...
class ProtocolService:
    ...
    def _apply_ui_state(self, snapshot: DeviceSnapshot, message: dict[str, Any]) -> ProtocolUpdate:
        snapshot.remote_ui_state, warning = coerce_ui_state(message.get("state"), default=UiState.IDLE)
        if warning:
