"""Pure local device-state transitions for the simulator."""
...
from simulator.domain.events import DeviceInputEvent, DeviceState, DomainEffect, EffectPayload
from simulator.domain.state import DeviceSnapshot
from simulator.shared.protocol import new_turn_id
...
class DeviceStateMachine:
    """Applies local transitions without depending on transport/UI code."""
