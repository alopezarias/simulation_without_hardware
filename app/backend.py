...
from app.application.services import message_bus as message_bus_service
from app.application.services import message_router as message_router_service
from app.application.services import recording as recording_service
from app.application.services import session_init as session_init_service
from app.application.services import turn_processing as turn_processing_service
from app.bootstrap import create_app
from app.config.settings import BackendSettings
from app.domain.session import DeviceSession as CoreDeviceSession
from app.infrastructure.logging.sanitizer import sanitize_message_for_log
from protocol import UiState, validate_device_message
...
async def websocket_endpoint(websocket: WebSocket) -> None:
    ...
    La app productiva usa el endpoint registrado en `app.bootstrap`.
