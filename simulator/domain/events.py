"""Local simulator device-state event and effect types."""
...
class DeviceState(str, Enum):
    """Observable local device states owned by the simulator."""
...
class DeviceInputEvent(str, Enum):
    """Single-button interactions supported by the device."""
...
class MenuOption(str, Enum):
    """Top-level menu entries navigated locally in the simulator."""
