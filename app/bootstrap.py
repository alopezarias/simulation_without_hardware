...
from protocol import validate_device_message

from app.application.context import AppContext
from app.application.services.message_bus import send_error
from app.application.services.message_router import handle_message
from app.config.settings import BackendSettings
from app.domain.session import DeviceSession
from app.infrastructure.ai.openclawd_gateway import OpenClawdGateway
from app.infrastructure.audio.temp_pcm_store import TempPcmAudioStore
from app.infrastructure.speech.speech_gateway import SpeechGateway
from app.infrastructure.transport.websocket_output import WebSocketOutput
